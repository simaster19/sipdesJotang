...
if (isset($_POST['submit'])) {
    ...
    //Insert Ayah
    $sqlAyah = mysqli_query($koneksi, "INSERT INTO ayah (id_surat_ayah,nik_ayah,nama_ayah,tanggal_lahir_ayah,umur_ayah,pekerjaan_ayah,alamat_ayah,rt_ayah,rw_ayah,desa_ayah,kecamatan_ayah,kota_ayah) VALUES ('$id_surat','$nik_ayah','$nama_ayah','$tanggal_lahir_ayah','$umur_ayah','$pekerjaan_ayah','$alamat_ayah','$rt_ayah','$rw_ayah','$desa_ayah','$kecamatan_ayah','$kota_ayah')");
    ...
    //Insert Ibu
    $sqlIbu = mysqli_query($koneksi, "INSERT INTO ibu (id_surat_ibu,nik_ibu,nama_ibu,tanggal_lahir_ibu,umur_ibu,pekerjaan_ibu,alamat_ibu,rt_ibu,rw_ibu,desa_ibu,kecamatan_ibu,kota_ibu) VALUES ('$id_surat','$nik_ibu','$nama_ibu','$tanggal_lahir_ibu','$umur_ibu','$pekerjaan_ibu','$alamat_ibu','$rt_ibu','$rw_ibu','$desa_ibu','$kecamatan_ibu','$kota_ibu')");
    ...
    //Insert Pelapor
    $sqlPelapor = mysqli_query($koneksi, "INSERT INTO pelapor (id_surat_pelapor,nik_pelapor,nama_pelapor,tanggal_lahir_pelapor,umur_pelapor,pekerjaan_pelapor,alamat_pelapor,rt_pelapor,rw_pelapor,desa_pelapor,kecamatan_pelapor,kota_pelapor) VALUES ('$id_surat','$nik_pelapor','$nama_pelapor','$tanggal_lahir_pelapor','$umur_pelapor','$pekerjaan_pelapor','$alamat_pelapor','$rt_pelapor','$rw_pelapor','$desa_pelapor','$kecamatan_pelapor','$kota_pelapor')");
    ...
    function ibu()
    {
        ...
        $queryIbu = mysqli_query($koneksi, "SELECT id_ibu FROM ibu WHERE nik_ibu = '$nik_ibu'");
        $dataIbu = mysqli_fetch_assoc($queryIbu);
        return $dataIbu['id_ibu'];
    }

    function ayah()
    {
        global $koneksi, $nik_ayah;
        $queryAyah = mysqli_query($koneksi, "SELECT id_ayah FROM ayah WHERE nik_ayah = '$nik_ayah'");
        $dataAyah = mysqli_fetch_assoc($queryAyah);
        return $dataAyah['id_ayah'];
    }

    function pelapor()
    {
        global $koneksi, $nik_pelapor;
        $queryPelapor = mysqli_query($koneksi, "SELECT id_pelapor FROM pelapor WHERE nik_pelapor = '$nik_pelapor'");
        $dataPelapor = mysqli_fetch_assoc($queryPelapor);
        return $dataPelapor['id_pelapor'];
    }
    ...
    if ($nik_saksi1 !== '' || $nama_saksi1 !== '') {
        //Insert Saksi1
        $sqlSaksi1 = mysqli_query($koneksi, "INSERT INTO saksi (id_surat,id_data_surat,nik_saksi,nama_saksi,tanggal_lahir_saksi,umur_saksi,pekerjaan_saksi,alamat_saksi,rt_saksi,rw_saksi,desa_saksi,kecamatan_saksi,kota_saksi,type_saksi) VALUES ('$id_surat','$id_data_surat','$nik_saksi1','$nama_saksi1','$tanggal_lahir_saksi1','$umur_saksi1','$pekerjaan_saksi1','$alamat_saksi1','$rt_saksi1','$rw_saksi1','$desa_saksi1','$kecamatan_saksi1','$kota_saksi1',1)");
    }
    if ($nik_saksi2 !== '' || $nama_saksi2 !== '') {
        //Insert Saksi2
        $sqlSaksi2 = mysqli_query($koneksi, "INSERT INTO saksi (id_surat,id_data_surat,nik_saksi,nama_saksi,tanggal_lahir_saksi,umur_saksi,pekerjaan_saksi,alamat_saksi,rt_saksi,rw_saksi,desa_saksi,kecamatan_saksi,kota_saksi,type_saksi) VALUES ('$id_surat','$id_data_surat','$nik_saksi2','$nama_saksi2','$tanggal_lahir_saksi2','$umur_saksi2','$pekerjaan_saksi2','$alamat_saksi2','$rt_saksi2','$rw_saksi2','$desa_saksi2','$kecamatan_saksi2','$kota_saksi2',2)");
    }
