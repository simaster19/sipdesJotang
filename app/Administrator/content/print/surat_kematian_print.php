...
<body>
    ...
    <h3 class="sub-title" style="text-decoration: underline; margin-bottom:1rem;">SURAT KETERANGAN KEMATIAN</h3>
    <table id="customers">
        <tr>
    ...
    <table id="customers2">
        <tr>
            <th colspan="3" class="sub-title" style="text-decoration: underline;">JENAZAH</th>
        </tr>
        <tr>
            <th>1.</th>
            <th>NIK</th>
        ...
        <tr>
            ...
            <th>:</th>
            <td><?= $data['tanggal_lahir_jenazah'] ?> / <?= $data['umur_jenazah'] ?></td>
        </tr>
        <tr>
            <th>5.</th>
            <th>Tempat Kelahiran</th>
            <th>:</th>
            <td><?= $data['tempat_lahir_jenazah'] ?></td>
        </tr>
        <tr>
            <th>6.</th>
            <th>Agama</th>
            <th>:</th>
            <td><?= $data['agama_jenazah'] ?></td>
        </tr>
        <tr>
            <th>7.</th>
            <th>Pekerjaan</th>
            <th>:</th>
            <td><?= $data['pekerjaan_jenazah'] ?></td>
        </tr>
        <tr>
            <th>8.</th>
            <th>Alamat</th>
            <th>:</th>
            <td><?= $data['alamat_jenazah'] ?> , RT/RW: <?= $data['rt_jenazah'] ?>/<?= $data['rw_jenazah'] ?> , Desa: <?= $data['desa_jenazah'] ?> , Kec: <?= $data['kecamatan_jenazah'] ?> , Kota: <?= $data['kota_jenazah'] ?></td>
        </tr>
        <tr>
            <th>9.</th>
            <th>Anak Ke</th>
            <th>:</th>
            <td><?= $data['anak_ke_jenazah'] ?></td>
        </tr>
        <tr>
            <th>10.</th>
