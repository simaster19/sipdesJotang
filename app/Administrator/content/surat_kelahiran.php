                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $data['ambil'] ?></td>
                                <td>
                                    <button data-bs-toggle="modal" data-bs-target="#ubahSuratKelahiran<?= $data['ids'] ?>" title="Ubah Pegawai" class="btn-ubahSuratKelahiran btn btn-primary rounded-pill"><i class="bi bi-pencil-fill"></i></button>
                                    ...
                                    <div class="modal modal-lg fade" id="ubahSuratKelahiran<?= $data['ids'] ?>" tabindex="-1" role="dialog" aria-labelledby="ubahSuratKelahiranTitle" data-bs-backdrop="false" aria-hidden="true">
